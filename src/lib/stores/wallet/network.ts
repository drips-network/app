...
export const NETWORK_CONFIG: ValueForEachSupportedChain<Network> = {
  ...
  [11155111]: {
    ...
    contracts: {
      ADDRESS_DRIVER: '0xB77F6Ed18E58d4f9d4986F23BcE40fcb9ce3B05a',
      DRIPS: '0x2cd644bACE1926DeA14693c125F4751c9B25f661',
      CALLER: '0x1347fC9023aB6f8be8c7D47D20b3f2e54AECDeC0',
      REPO_DRIVER: '0xE2111564E384d6D55D1Ce6e3dF5f2cfE24004DfA',
      NFT_DRIVER: '0x07418488D535fed8E765e9Ca993611BceA79af00',
      NATIVE_TOKEN_UNWRAPPER: undefined,
      SUB_ACCOUNT_REPO_DRIVER: '0xA3F066e41DF5c0037ED67dA0a546bC9382B46fD1',
    },
    settlement: {
      nextSettlementDate: nextMainnetSettlementDate,
      frequencyLabel: 'on the last Thursday of every month',
  ...
  [31337]: {
    ...
    token: 'ETH',
    id: '0x7A69',
    rpcUrl: `${BASE_URL}/api/rpc/anvil/localtestnet`,
    icon: Ethereum,
    color: '#627EEA',
    isTestnet: true,
