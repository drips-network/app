  ...
  const FEATURED_PROJECT_ACCOUNT_IDS =
    {
      1: [
        ...
        '80927335273972468167722947750338907267861671542981060844246982983680', // startkenet.js
        '80927325632295926773992520689210905998818993360029926329589912567808', // snapshot
        '80921553623925136102837122090833817680905654300253563247299252977664', // svelte-stepper
      ],
      5: [
