...
<div class="privacy-policy">
  ...
  <section>
    ...
    <p>
      ...
      (e.g. by reference to an online identifier).
    </p>
    <p>
      This privacy policy informs you in accordance with Art. 12 et seqq. GDPR about the processing
      of your personal data when you use Drips Services. In particular, it explains what personal
      data we collect and what we use it for. It also informs you how and for what purpose this is
      done, the legal basis for it, and what your rights are in relation to it.
    </p>
    <p>
      This privacy policy expressly refers to the website-specific data processing processes as
      described under 1.1 when you visit Drips Services. Separate privacy policies apply to other
      data processing by the Association.
    </p>
  </section>
  ...
  <section>
    <h2>Controller</h2>
    <p>
      According to the GDPR, the controller is the natural or legal person who alone or jointly with
      others determines the purposes and means of the processing of personal data.
    </p>
    <p>
      The controller for the data processing processes covered by this privacy policy, is, unless
  ...
  <section>
    <h2>Purposes and legal bases of data processing</h2>

    <h3>Visit of the Drips Services – server log files</h3>
    <p>
    ...
    <p>
      ...
      Services purely statistically and without drawing any conclusions about your person. This data
      is not merged with other data sources, nor is it analyzed for marketing purposes.
    </p>
    <p>
    ...
    <p>
      On Drips Services, users may access a 'Get In Touch' form on various subpages (e.g. after
      selecting a use case such as 'Run a RetroPGF round', 'Fund entire ecosystems' or 'Discuss a
      funding program' or by using the general contact option). The form is provided via our service
      provider Notion to collect and store your provided data, solely for the purpose of responding
      to your inquiry.
    </p>
    <p>
      If you contact us as part of an existing contractual relationship, make support requests or
      contact us in advance for information about our range of products and services, the data you
      provide will be processed for the purpose of processing and responding to your inquiries in
      accordance with Art. 6 (1) sentence 1 lit. b GDPR (legal basis). In all other cases,
      processing is based on our legitimate interest in and for the purpose of appropriately
      handling and responding to inquiries and improving communication with interested parties, in
      accordance with Art. 6 (1) sentence 1 lit. f GDPR.
    </p>
    <p>
      To submit the form, certain information is required: name, email address, your message, and
      confirmation that we may respond to your inquiry via the provided contact details. This
      information is not legally or contractually required, but it is necessary to process your
      inquiry. Without it, we are unable to properly receive, assign, or respond to your inquiry,
      and therefore cannot accept it for submission in the first place. Any additional information
      you provide (such as your organization, role or Telegram handle) is voluntary and helps us
    ...
    <p>
      The same applies if you contact us via the email address provided on Drips Services. In this
      case, we process the personal data you provide (e.g. your email address and message) on the
      same legal basis and for the same purposes as outlined above.
    </p>
    <p>
      As a rule, we delete the personal data you provided via the contact form or by email once
    ...
    <p>
      Because certain of the Drips Web App functions are built on decentralized and immutable
      infrastructures, any information committed on-chain or to the InterPlanetary File System
      ("IPFS") becomes permanently public and cannot be deleted. We therefore process no more
      personal data than is technically necessary to provide the requested functionality.
    </p>

    <h4>Connecting and using a Web3 Wallet</h4>
    <p>
    ...
    <p>
      ...
      processed or become visible:
    </p>
    <ul>
      <li>
        Your wallet address on supported networks (Ethereum address or of other Ethereum-compatible
        chains such as OP Mainnet or Filecoin)
      </li>
      <li>
    ...
    <p>
      This data is disclosed by you through voluntary interaction with the protocol and is required
      to execute the intended functionalities (e.g. making donations, claiming or distributing
      funds, submitting applications, or managing voting rounds). The legal basis for processing is
      your contractual relationship with us or another party (Art. 6 (1) sentence 1 lit. b GDPR),
      where applicable, or our legitimate interest in operating a transparent, user-driven protocol
      (Art. 6 (1) sentence 1 lit. f GDPR).
    </p>
    <p>
      All interactions with the Drips Protocol are written to public and immutable infrastructures,
      including blockchains (e.g. Ethereum-compatible networks such as OP Mainnet or Filecoin) and,
      where applicable, the IPFS. As a result, submitted data becomes publicly accessible and cannot
      be deleted due to the nature of these systems.
    </p>
    <p>
    ...
    <p>
      ...
      your interactions with the protocol. Please note, however, that any data you publish on-chain
      (e.g. through transactions or public attestations) is visible to everyone and permanently
      accessible.
    </p>

    <h4>Additional role-specific protocol functions within the Drips Protocol</h4>
    <p>
      Depending on your role and interaction with the Drips Web App, additional categories of data
      may be processed in order to provide the respective protocol functionality and enable access
      to our services. This includes, for example, creating or managing funding flows, claiming
      open-source projects, participating in funding rounds, or reviewing applications. The legal
      basis for processing your data in these cases is either your contractual relationship with us
      or another party (Art. 6 (1) sentence 1 lit. b GDPR) or our legitimate interest in offering
      and maintaining the related protocol features (Art. 6 (1) sentence 1 lit. f GDPR).
    </p>

    <h5>As a project maintainer / funding recipient</h5>
    <p>
      If you claim a GitHub repository and receive funding via the Drips Protocol, we process your
      wallet address on supported networks and require proof-of-ownership of the repository (e.g. by
      committing a verification file to the repository). If you choose to forward received funds to
      dependencies, the related recipient addresses and share allocations (i.e. a list of downstream
      recipients such as wallets, Drip Lists, or repositories, each with a defined percentage) are
      also public. This data is processed solely to enable your participation and distribution of
      funds via the protocol.
    </p>

    <h5>As a Retroactive Public Goods Funding ("RPGF") round admin</h5>
    <p>
      If you initiate or manage an RPGF round, we process your wallet address on supported networks
      as well as the configuration data for the round, such as round name, descriptions, eligible
      voter addresses, optionally a list of additional wallet addresses to act as co-admins, and
      review decisions. This data is required to enable RPGF functionality. Most information is
      public, except the voter list, which is visible only to round admins and select platform
      maintainers for maintenance purposes.
    </p>

    <h5>As an RPGF applicant</h5>
    <p>
      If you submit an application for an RPGF round, we process your wallet address on supported
    ...
    <h5>As an RPGF voter</h5>
    <p>
      If you participate in voting, your wallet address on supported networks and vote allocations
      are collected and stored. This information is only visible to round admins and selected
    ...
    <p>
      We process your personal data in accordance with Art. 6 (1) sentence 1 lit. c GDPR (legal
      basis) to fulfill a legal obligation to which we are subject.
    </p>

    <h3>Law enforcement</h3>
    <p>
      We also process your personal data in order to assert our rights and enforce our legal claims.
      We also process your personal data in order to be able to defend ourselves against legal
      claims. Finally, we process your personal data insofar as this is necessary for the prevention
  ...
  <section>
    <h2>Consent-based data processing</h2>
    <p>
      If you have given us your consent to process personal data for specific purposes, the
      lawfulness of this processing is based on your consent.
    </p>
    <p>The legal basis in this case is Art. 6 (1) sentence 1 lit. a GDPR.</p>
    <p>
      Consent can be revoked at any time. Please note that the revocation only takes effect in the
      future, so processing up to that point is not affected.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      Within our company, access to your data is granted to those departments that need it to
      fulfill our contractual and legal obligations or to exercise our rights.
    </p>
    <p>
      Service providers and vicarious agents employed by us (e.g. technical service providers,
      shipping companies, waste disposal companies) may also receive data for these purposes.
    </p>
    <p>
      In some cases, the recipients receive your personal data as processors and are then strictly
      bound by our instructions when handling your personal data. These processors include the
  ...
  <section>
    ...
    <p>
      ...
      period also includes the periods of initiation of a contract (pre-contractual legal
      relationship) and the performance of a contract (including any subsequent claims).
    </p>
    <p>
    ...
    <p>
      ...
      time you give your consent until the time you withdraw your consent or until the time the
      processing covered by the consent is completed.
    </p>
    <p>
      In this respect, we would like to point out that even in the event of withdrawal of consent,
      further processing may be possible on the basis of other legal bases (Art. 17 (1) lit. b
      GDPR).
    </p>
    <p>
      Even if the primary processing purposes have been achieved, further processing of your
      personal data may take place, in particular if this is necessary to fulfill a legal obligation
      and/or to protect our rights. This includes the following purposes in particular:
    </p>
    <ul>
      <li>
  ...
  <section>
    <h2>Social Media</h2>
    <p>
      In addition, we also use various social media services, some of which we have integrated
      directly on the Drips Services or websites, which we are represented on. Those services might
      process personal data. Further information on data processing can be found in the respective
      social media services' privacy policies. There you will also find further information on your
      rights and setting options to protect your personal data.
    </p>
  ...
  <section>
    <h2>Data security</h2>
    <p>
      Personal data is protected by us by means of suitable technical and organizational measures in
    ...
    <p>
      ...
      protect the transmission of confidential content, such as the contact requests you send to us
      as the site operator. You can recognize an encrypted connection by the fact that the address
      line of the browser changes from "http://" to "https://" and by the lock symbol in your
      browser line. If SSL or TLS encryption is activated, the data you transmit to us cannot be
      intercepted by third parties.
    </p>
    <p>
      Nevertheless, we would like to point out that data transmission over the Internet (e.g. when
      communicating by e-mail) can have security gaps. Complete protection of data against access by
      third parties is therefore not possible.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      concerning you are being processed, and, where that is the case, you have the right to obtain
      access to the personal data concerning you and the information pursuant to Art. 15 (1) lit.
      a-h GDPR. Where personal data concerning you are transferred to a third country or to an
      international organization, you have the right to be informed of the appropriate safeguards
      pursuant to Art. 46 GDPR relating to the transfer. Subject to the conditions set out in Art.
      15 GDPR, you have the right to receive a copy of the personal data concerning you undergoing
      processing.
    </p>
    ...
    <p>
      You have the right to obtain from us the erasure of personal data concerning you without undue
      delay if one of the grounds listed in Art. 17 GDPR applies, e.g. if the data have been
      unlawfully processed.
    </p>

    <h3>Right to restriction of processing</h3>
    <p>
      Subject to the conditions set out in Art. 18 GDPR, you have the right to obtain from us
      restriction of processing.
    </p>

    <h3>Right to data portability</h3>
    <p>
      Subject to the conditions set out in Art. 20 GDPR, you have the right to receive the personal
      data concerning you, which you have provided to us, in a structured, commonly used and
      machine-readable format and you have the right to transmit those data to another controller
      without hindrance from us. In exercising your right to data portability, you have the right to
      have the personal data concerning you transmitted directly from us to another controller,
      where technically feasible.
    </p>

    <h3>Right to withdraw consent</h3>
    <p>
      If the data processing is based on consent pursuant to Art. 6 (1) lit. a GDPR or Art. 9 (2)
      lit. a GDPR, you have the right to withdraw your consent at any time. The withdrawal of
      consent shall not affect the lawfulness of processing based on consent before its withdrawal.
      If you withdraw your consent, you can also choose, inter alia, the contact channel that you
      used when giving your consent.
    </p>
  ...
  <section>
    ...
    <p>
      Subject to the conditions set out in Art. 21 GDPR, you have the right to object, on grounds
      relating to your particular situation, at any time to processing of personal data concerning
      you which is based on lit. (e) or (f) of Art. 6 (1) GDPR, including profiling based on those
      provisions. Where personal data concerning you are processed for direct marketing purposes,
      you have the right to object at any time to processing of personal data concerning you for
      such marketing, which includes profiling to the extent that it is related to such direct
      marketing.
    </p>
    <p>
      Subject to the conditions set out in Art. 21 GDPR, where personal data concerning you are
      processed for scientific or historical research purposes or statistical purposes pursuant to
      Art. 89 (1) GDPR you, on grounds relating to your particular situation, have the right to
      object to processing of personal data concerning you.
    </p>
  </section>

  <section>
    <h2>Obligation to provide data</h2>
    <p>
      In principle, you are not obliged to provide us with your personal data. However, if you do
      not do so, we will not be able to make the Drips Services without restriction or answer your
      inquiries to us.
    </p>
    <p>
      Personal data that we do not necessarily require for the above-mentioned processing purposes
      is marked accordingly as voluntary information.
    </p>
  </section>
  ...
  <section>
    ...
    <p>
      We do not use automated decision-making in the meaning of Art. 22 (1) GDPR or profiling (an
      automated analysis of your personal circumstances).
    </p>
  </section>
