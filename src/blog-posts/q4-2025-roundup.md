...
One of the standout moments of Q4 was the [launch of the first end-to-end RetroPGF round on Drips](https://www.drips.network/blog/posts/rpgf-launch-with-filecoin) with **Filecoin**. The round was run entirely through Drips, from applications and evaluation through to on-chain distribution.
...
There’s plenty more info about Drips Wave [here](https://docs.drips.network/wave) and you’ll be hearing about it a lot more as we run regular Waves in the coming months. The first full Wave will begin on January 21st 2026 with the **Stellar Development Foundation**.
...
If you’d like to stay up to date on what we’re building, you can find us on [Discord](https://discord.com/invite/BakDKKDpHF), [X](https://x.com/dripsnetwork), and [Bluesky](https://bsky.app/profile/drips.network).
