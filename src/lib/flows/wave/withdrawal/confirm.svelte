<script lang="ts">
  ...
  function handleSubmit() {
    dispatch('await', {
      ...
      promise: async () => {
        await requestWithdrawal(undefined, grant.id, $context.stellarAddress);
...
>
        ...
        <ul>
          ...
          <li>
            I have read the <a
              ...
              class="typo-link">Drips Wave Terms</a
            >
          </li>
        </ul>
      </div>
  ...
  {#snippet actions()}
    <Button variant="normal" onclick={handleBack}>Back</Button>
