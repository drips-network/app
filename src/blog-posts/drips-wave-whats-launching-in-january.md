...
For the first ever Drips Wave we’re working with the [Stellar Development Foundation](https://stellar.org/foundation). Stellar has demonstrated a clear commitment to creating practical, accessible pathways for developers at all levels. Their commitment to Waves reflects a broader effort to:
...
> **Early Bonus Program:** Developers who sign up before **11 January 2026** can claim 100 pre-launch points. Full details are [here](https://www.drips.network/campaigns/wave-launch-points-bonus).

Please check back here for more information on Stellar Wave 1, and follow us on [X](https://x.com/dripsnetwork), [Bluesky](https://bsky.app/profile/drips.network) or come say hi in our [Discord](https://discord.com/invite/BakDKKDpHF).
