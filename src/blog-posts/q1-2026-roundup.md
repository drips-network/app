...
We have shared quite a bit already about what Wave is and how it works, so won’t rehash all of that here. Check out this post [here](https://www.drips.network/blog/posts/drips-wave-whats-launching-in-january) if you need a refresher. What matters is that it is out there, running in the wild and people are benefiting from it.
...
Find out more about this pilot in our blog post [here](https://www.drips.network/blog/posts/exploring-sustainable-funding-for-digital-public-goods-with-unicef), or watch the video explainer below.

<BlogVideoPlayer src="https://www.youtube-nocookie.com/embed/RMWTZ_GJvog" />

### **Protocol updates**

We also updated the Drips Protocol to validate ownership of GitHub repositories using [Lit Protocol](https://www.litprotocol.com/). This makes project claiming faster especially on Filecoin, and adds an additional layer of verifiability to repo claims thanks to [Trusted Execution Environments](https://en.wikipedia.org/wiki/Trusted_execution_environment) (TEEs). It also removes Gelato Functions as an chain-specific dependency, allowing the Drips Protocol to be deployed on additional chains much faster.
...
If you want to stay up to date with what we are working on, follow us on [X](https://x.com/dripsnetwork) or [Bluesky](https://bsky.app/profile/drips.network), join our [Discord](https://discord.com/invite/t8XBXZAEs5) & keep an eye on the blog for future updates.
